...
(
  ...
  output [6:0]     o_hw_i2c_ctrl_i2c_id,
  output [15:0]    o_hw_i2c_ctrl_data,
  ...
  reg    [6:0]     o_hw_i2c_ctrl_i2c_id_q;
  reg    [15:0]    o_hw_i2c_ctrl_data_q;
  ...
  reg              o_hw_i2c_ctrl_i2c_id_q_wen;
  ...
  assign o_hw_i2c_ctrl_i2c_id = o_hw_i2c_ctrl_i2c_id_q;
  ...
  always @(*) begin
    ...
    case(i_sw_address)
      ...
      5'h10:  o_sw_rddata_next = {8'b0, o_hw_i2c_ctrl_write_q, o_hw_i2c_ctrl_data_q,
                                  o_hw_i2c_ctrl_i2c_id_q};
  ...
  always @(*) begin
        ...
        o_hw_i2c_ctrl_i2c_id_q_wen = 1'b0;
    ...
    case(i_sw_address)
      ...
      5'h10: begin
        o_hw_i2c_ctrl_i2c_id_q_wen = i_sw_write & i_sw_select;
  ...
  always @(posedge clk) begin
    if (reset) begin
      ...
      o_hw_i2c_ctrl_i2c_id_q <= 7'h0;
      o_hw_i2c_ctrl_data_q <= 16'h0;
      ...
      // Register: i2c_ctrl | Field: o_hw_i2c_ctrl_i2c_id
      if (o_hw_i2c_ctrl_i2c_id_q_wen) o_hw_i2c_ctrl_i2c_id_q <= i_sw_wrdata[6:0];

      // Register: i2c_ctrl | Field: o_hw_i2c_ctrl_data
      if (o_hw_i2c_ctrl_data_q_wen) o_hw_i2c_ctrl_data_q <= i_sw_wrdata[22:7];

      // Register: i2c_ctrl | Field: o_hw_i2c_ctrl_write
      if (o_hw_i2c_ctrl_write_q_wen) o_hw_i2c_ctrl_write_q <= i_sw_wrdata[23:23];
