...
#define AUDIO_CONTROLLER__STATUS__I2C_IDLE__get(data) \
        ((data >> AUDIO_CONTROLLER__STATUS__I2C_IDLE__OFT) & AUDIO_CONTROLLER__STATUS__I2C_IDLE__MASK)
...
#define AUDIO_CONTROLLER__STATUS__DAC_FIFO_FULL__get(data) \
        ((data >> AUDIO_CONTROLLER__STATUS__DAC_FIFO_FULL__OFT) & AUDIO_CONTROLLER__STATUS__DAC_FIFO_FULL__MASK)
...
#define AUDIO_CONTROLLER__STATUS__ADC_FIFO_EMPTY__get(data) \
        ((data >> AUDIO_CONTROLLER__STATUS__ADC_FIFO_EMPTY__OFT) & AUDIO_CONTROLLER__STATUS__ADC_FIFO_EMPTY__MASK)
...
#define AUDIO_CONTROLLER__CTRL__DAC_SEL__get(data) \
        ((data >> AUDIO_CONTROLLER__CTRL__DAC_SEL__OFT) & AUDIO_CONTROLLER__CTRL__DAC_SEL__MASK)
...
#define AUDIO_CONTROLLER__CTRL__ADC_SEL__get(data) \
        ((data >> AUDIO_CONTROLLER__CTRL__ADC_SEL__OFT) & AUDIO_CONTROLLER__CTRL__ADC_SEL__MASK)
...
#define AUDIO_CONTROLLER__I2C_CTRL__I2C_ID__get(data) \
        ((data >> AUDIO_CONTROLLER__I2C_CTRL__I2C_ID__OFT) & AUDIO_CONTROLLER__I2C_CTRL__I2C_ID__MASK)
...
#define AUDIO_CONTROLLER__I2C_CTRL__WRITE__get(data) \
        ((data >> AUDIO_CONTROLLER__I2C_CTRL__WRITE__OFT) & AUDIO_CONTROLLER__I2C_CTRL__WRITE__MASK)
