...
# Sat Oct 10 11:36:12 PDT 2020
# DO NOT MODIFY


# 
# avm_sram_controller "avm_sram_controller" v1.0
# Heqing Huang 2020.10.10.11:36:12
# Avalon MM SRAM Controller
# 
...
# 
set_module_property DESCRIPTION "Avalon MM SRAM Controller"
...
add_interface_port avalon_slave avm_writedata writedata Input 16
add_interface_port avalon_slave avm_readdata readdata Output 16
add_interface_port avalon_slave avm_read read Input 1
add_interface_port avalon_slave avm_byteenable byteenable Input 2
add_interface_port avalon_slave avm_address address Input 18
